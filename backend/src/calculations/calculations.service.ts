...
export class CalculationsService {
  ...
  /**
   * Same shape as daily(), but for an arbitrary calendar range rather than
   * the current BusinessDay — powers the Week/Month tabs, which don't have
   * a "business day" concept of their own (a business day only exists for
   * the open/closeable *current* day).
   */
